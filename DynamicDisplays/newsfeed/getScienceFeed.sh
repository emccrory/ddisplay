...
(
  ...
  /bin/sed 's/>/>\n/g' tempN1 | sed 's-<channel rdf:about.*>-<channel>-g' | sed 's-<item rdf.*>-<item>-g' | sed 's-&amp;nbsp;- -g' | sed 's/&amp;mdash;/ - /g' | sed 's-&nbsp;- -g' | sed 's/&mdash;/ - /g' | sed 's/&ouml;/o/g' | sed 's/&amp;ouml;/o/g' | sed 's/&amp;rsquo;//g'| sed 's/&rsquo;//g' | sed 's/&amp;lsquo;//g'| sed 's/&lsquo;//g' | sed 's-&lt;/div&gt;- -g' | sed 's-&lt;br/&gt;- -g' | sed 's-<em>--g' | sed 's-</em>--g' | sed 's/\&lt;a href=.*&gt;/ /g' | sed 's-<description>.*-<description>-g' | sed 's-<br/>--g' | sed 's/dc://g' | sed 's/atom://g' | sed 's/media://g' | sed 's/, left,//g' | sed 's/, right,//g' | sed 's/, center,//g' | sed 's- – <a href=.*>- \.\.\.-g' | sed 's/&lt;img .*&gt;//g' | sed 's/ type="html"//g' | sed 's-</p>--g' | sed 's-</i>--g' | sed 's/<strong>//g' | sed 's-</strong>--g' > tempN2
