...
/**
 * Holds the definitions of some Channels in the XOC signage system so that a channel can be
 * selected in the touch panel.  This was a prototype that was used before the database was established.
 * 
...
public class ChannelCatalogTesting extends HashMap<String, SignageContent> implements ChannelCatalog {
	...
	public static final char NU = 0x3bd;
	...
	public static final ChannelDesc [] Public = {
			new ChannelDesc("MINOS",
					"Public info on the Main Injector Neutrino Oscillation Something"),
			new ChannelDesc("MINER" + NU + "A",
					"a neutrino scattering experiment which uses the NuMI beamline"),
			new ChannelDesc("MiniBooNE",
					"test for neutrino mass by searching for neutrino oscillations"),
			new ChannelDesc(
					"MicroBooNE",
			...
			new ChannelDesc("Accelerator",
					"Useful public information on the Fermilab Accelerator Chain"), };

	public static final String [] DetailedOne = { "MINOS a", "MINOS b", "MINOS c", "MINOS d",
			"MINER" + NU + "A a", "MINER" + NU + "A b", "MINER" + NU + "A c", "MINER" + NU + "A d",
			"MiniBooNE a", "MiniBooNE b", "MiniBooNE c", "MiniBooNE d", "MicroBooNE a",
			"MicroBooNE b", "MicroBooNE c", "MicroBooNE d", "Mu2E a", "Mu2E b", "Mu2E c", "Mu2E d",
			"Muon g-2 a", "Muon g-2 b", "Muon g-2 c", "Muon g-2 d", "SeaQuest a", "SeaQuest b",
			"SeaQuest c", "SeaQuest d", "LNBE a", "LNBE b", "LNBE c", "LNBE d", "NO" + NU + "A a",
			"NO" + NU + "A b", "NO" + NU + "A c", "NO" + NU + "A d", "Accelerator a",
			"Accelerator b", "Accelerator c", "Accelerator d", };

	public static final String [] DetailedTwo = { "MINOS XA", "Muon g-2 XB", "Mu2E XC", "MINOS XD",
			"Muon g-2 XE", "Mu2E XF", "MINOS XG", "Muon g-2 XH", "Mu2E XX", "MINOS XY",
			"Muon g-2 XZ", "Mu2E XA1", "MINOS XB1", "Muon g-2 XC1", "Mu2E XD1", "MINOS XE1",
			"Muon g-2 XF1", "Mu2E XG1", "MINOS XH1", "Muon g-2 XX1", "Mu2E XY1", "MINOS XZ1",
			"A NO" + NU + "A", "B NO" + NU + "A", "C NO" + NU + "A", "D NO" + NU + "A",
			"E NO" + NU + "A", "A MINER" + NU + "A", "B MINER" + NU + "A", "C MINER" + NU + "A",
			"D MINER" + NU + "A", "E MINER" + NU + "A", "A SeaQuest", "B SeaQuest", "C SeaQuest",
			"D SeaQuest", "E SeaQuest", "A MiniBooNE",
			"B MiniBooNE a d f another onethingshshshshshshhshsgsgsgs", "C MiniBooNE",
			"D MiniBooNE", "E MiniBooNE", "A Accelerator", "B Accelerator", "C Accelerator",
			"D Accelerator", "E Accelerator", "A LBNE", "B LBNE", "C LBNE", "D LBNE", "E LBNE", };

	public static final ChannelDesc [] MetaChannels = {
			new ChannelDesc("List of Channels",
					"List of all the channels defined in the XOC Signage Display System"),
			new ChannelDesc("List of Displays",
					"List of all the Displays that are controlled by the XOC Signage Display Sisytem"),
			...
			new ChannelDesc("Weather",
					"Current weather conditions at Fermilab and all the far sites"),
	 ...
	 * (non-Javadoc)
	 * @see
	 * gov.fnal.ppd.xoc.signage.changer.ChannelCatalog#getChannelCatalog(gov.fnal.ppd.xoc.signage.changer
	 * .ChannelCategory)
	 */
	@Override
