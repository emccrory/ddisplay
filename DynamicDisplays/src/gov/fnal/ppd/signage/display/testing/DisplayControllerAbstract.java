...
/**
 * Implement a Dynamic Display using an underlying browser (currently, Opera)
 * 
...
public abstract class DisplayControllerAbstract extends DisplayImpl {
	 ...
	 */
	public static DisplayControllerAbstract makeDynamicDisplayByNumber(final int number, Class<?> class1) {
		try {
