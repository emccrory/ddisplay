...
public class Orig_Client {
	 ...
	 */
	Orig_Client(String server, int port, String username) {
	 ...
	 */
	Orig_Client(String server, int port, String username, Orig_ClientGUI cg) {
		this.server = server;
		this.port = port;
	 ...
	 */
	void sendMessage(Orig_ChatMessage msg) {
		try {
	...
	public static void main(String[] args) {
		...
		Orig_Client client = new Orig_Client(serverAddress, portNumber, userName);
		...
		while (true) {
			...
			if (msg.equalsIgnoreCase("LOGOUT")) {
				client.sendMessage(new Orig_ChatMessage(Orig_ChatMessage.LOGOUT, ""));
				// break to do the disconnect
				break;
			}
			// message WhoIsIn
			else if (msg.equalsIgnoreCase("WHOISIN")) {
				client.sendMessage(new Orig_ChatMessage(Orig_ChatMessage.WHOISIN, ""));
			} else { // default to ordinary message
				client.sendMessage(new Orig_ChatMessage(Orig_ChatMessage.MESSAGE, msg));
			}
		}
		// done disconnect
		client.disconnect();
