...
set classpath=bin;target/classes;lib/mysql-connector-java-5.1.27.jar;lib/slf4j-api-1.5.8.jar;lib/slf4j-log4j12-1.5.8.jar;lib/selenium/selenium-server-standalone-3.141.59.jar
